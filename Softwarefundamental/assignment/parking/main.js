        ...
        password.addEventListener('keypress', (event) => {
            if (event.key == 'Enter') {
                ...
                if (password.value == '' || password.value.length < 8 ||
                    !(password.value.match(/[a-z]/g) && password.value.match(/[A-Z]/g) && password.value.match(/[0-9]/g) && password.value.match(/[^a-zA-Z\d]/g))) {
...
function displayPricing(submit, event) {
    submit.addEventListener('click', (event) => {
        document.getElementById('PriceHeader').style.display = '';
        let vehicleType = document.getElementById(empVehicleDetails.Type.toUpperCase());
...
function dollerToYen() {
    ...
    let lablePrice = document.getElementById('Price');
    lablePrice.innerHTML = String(parseInt(price.value) * 110.71) + ' YEN ';
}
document.getElementById('EmpAdd').addEventListener("click", displayEmp, false);
document.getElementById('VehicleAdd').addEventListener("click", addVehicle, false);
document.getElementsByClassName('Pricing-Buttons')[0].addEventListener("click", PurchaseNow, false);
document.getElementsByClassName('Pricing-Buttons')[1].addEventListener("click", PurchaseNow, false);
document.getElementsByClassName('Pricing-Buttons')[2].addEventListener("click", PurchaseNow, false);
document.getElementById('amount').addEventListener('click', dollerToYen, false);
